...
ActionLink = React.createClass({
  ...
  render: function () {
    ...
    if (this.state.comments === null) {
      ...
      comments = React.createElement(
        'div',
        null,
        'No comments yet. Be a brave soul, and be the first to share your thoughts.'
      );
    } else {
      comments = React.createElement(CommentList, { comments: this.state.comments });
    }
    return React.createElement(
      ...
      React.createElement(
        'p',
        { className: "content-head is-center" },
        this.props.question.truth
      ),
      React.createElement(CommentForm, { question: this.props.question, onCommentSubmit: this.handleCommentSubmit }),
      React.createElement(
        'h2',
        { className: "content-head is-center" },
        'Community Replies'
  ...
  render: function () {
    return React.createElement(
      "form",
      { ref: "form", className: "pure-form pure-form-stacked", onSubmit: this.handleSubmit },
      React.createElement(
        "p",
        null,
  ...
  renderQuestions: function () {
    ...
    return React.createElement(QuestionList, { questions: this.state.questions, onSelect: this.selectQuestion });
  },

  renderComments: function () {
    if (this.state.selectedQuestion === null) return React.createElement(
      "div",
      null,
      React.createElement(
        "h2",
    ...
    return React.createElement(QuestionComments, { question: this.state.selectedQuestion });
  },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "h4",
        null,
        "In early 2015, the New York Times published a classic Modern Love post."
      ),
      React.createElement(
        "p",
        null,
        "Mandy Len Catron’s essay, ",
        React.createElement(
          "a",
          { href: "http://www.nytimes.com/2015/01/11/fashion/modern-love-to-fall-in-love-with-anyone-do-this.html" },
          "“To Fall in Love With Anyone, Do This”"
        ),
        ", claimed that a pair of strangers could fall in love after answering 36 questions together. In the essay, Catron refers to a ",
        React.createElement(
          "a",
          { href: "http://psp.sagepub.com/content/23/4/363.full.pdf+html" },
          "study by the psychologist Arthur Aron (and others)"
        ),
        " that explores whether intimacy between two strangers can be accelerated by having them ask each other a specific series of personal questions. Not surprisingly, the essay went viral."
      ),
      React.createElement(
        "h4",
        null,
        "And then a lot of people got nervous."
      ),
      React.createElement(
        "p",
        null,
        "Imagine this scenario: your partner / wife / boyfriend / summer fling read the article and wants to talk about the questions on your date tonight. Are you ready to answer?"
      ),
      React.createElement(
        "h4",
        null,
        "At Veritas, we make this conversation a little less scary."
      ),
      React.createElement(
        "p",
        null,
        "We provide a space for you to test out your answers with the community first, before having to answer the questions with your partner."
      ),
      React.createElement(
        "div",
        { className: "pure-g" },
        React.createElement(
          "div",
          { className: "l-box-lrg pure-u-1-2" },
          React.createElement(
            "h2",
            { className: "content-head is-center" },
            " To begin, find a question you would like to answer. "
          ),
...
App.router = function (path) {
  ...
  if (path.match(/^\/questions\/(\d+)\/comments$/)) return React.createElement(CommentShowPage, { question_id: RegExp.$1 });
  return React.createElement(
    'h1',
    null,
    'Page Not Found'
...
$(function () {
  React.render(React.createElement(MainComponent, null), document.body);
